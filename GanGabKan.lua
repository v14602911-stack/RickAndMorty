-- =====================================================================
-- FIRE GUN (Rick and Morty style) + MOBILE BUTTON by DeepSeek
-- =====================================================================
...
print("🔥 FIRE GUN (mobile version) загружена!")
print("🔥 Тапни по кнопке 🔥 справа — выстрел")
print("🔥 Зажми кнопку — очередь")
